...
Set working direction and load in the files. Change the working directory as required. 
```{r}
library(readr)
setwd("C:/Users/clare/OneDrive - Deakin University/3_Shrubs/Results June 2024") # Change the working directory as required
df_alldata <- read_csv("C:/Users/clare/OneDrive - Deakin University/3_Shrubs/Paper Submissions/Appendicies/S2.4. Data of mean shrub cover-abundance used to construct GLMM.csv")
view(df_alldata)
```
